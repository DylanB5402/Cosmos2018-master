...
public class ArmConstants {
    ...
    public static final double kArmF = 2.34;


    public static final int kArmUpPos = 1000;
    public static final int kArmDownPos = 2511;
    ...
    public static final int kArmAcceleration = 438;
